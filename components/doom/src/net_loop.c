...
EXT_RAM_BSS_ATTR static packet_queue_t client_queue;
EXT_RAM_BSS_ATTR static packet_queue_t server_queue;
EXT_RAM_BSS_ATTR static net_addr_t client_addr;
EXT_RAM_BSS_ATTR static net_addr_t server_addr;
