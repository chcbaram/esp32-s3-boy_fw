...
EXT_RAM_BSS_ATTR boolean         playeringame[MAXPLAYERS]; 
EXT_RAM_BSS_ATTR player_t        players[MAXPLAYERS]; 

EXT_RAM_BSS_ATTR boolean         turbodetected[MAXPLAYERS];
...
EXT_RAM_BSS_ATTR byte		consistancy[MAXPLAYERS][BACKUPTICS]; 
...
EXT_RAM_BSS_ATTR static boolean  gamekeydown[NUMKEYS]; 
static int      turnheld;		// for accelerative turning 
 
EXT_RAM_BSS_ATTR static boolean  mousearray[MAX_MOUSE_BUTTONS + 1];
...
EXT_RAM_BSS_ATTR static boolean  joyarray[MAX_JOY_BUTTONS + 1]; 
...
EXT_RAM_BSS_ATTR mobj_t*		bodyque[BODYQUESIZE]; 
int		bodyqueslot; 
